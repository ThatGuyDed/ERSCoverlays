...
class GraphicsUpdater {
    ...
    constructor(settings, spreadsheetID, worksheetName, apiKey, updateInterval=3000, updateNow=true) {
        ...
        this.operations = {
            ...
            'format': (id, cellValue) => {
                if(cellValue == 'BO5'){
                    document.getElementById("ScoreboardBO5").style.display = ''
                    document.getElementById("ScoreboardBO7").style.display = 'none'
                }else{
                    document.getElementById("ScoreboardBO7").style.display = ''
                    document.getElementById("ScoreboardBO5").style.display = 'none'
                }
            }
        }

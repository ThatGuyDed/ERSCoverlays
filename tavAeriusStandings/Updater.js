class GraphicsUpdater {
    constructor(settings, spreadsheetID, worksheetName, apiKey, updateInterval=3000, updateNow=true) {
        ...
        this.operations = {
            ...
            'tier': (id, cellValue) => {
                if(cellValue == "Academy"){
                    document.getElementById(id).src = "ModularPieces/academy.png";
                }else if(cellValue == "Prospect"){
                    document.getElementById(id).src = "ModularPieces/prospect.png";
                }else if(cellValue == "Challenger"){
                    document.getElementById(id).src = "ModularPieces/challenger.png";
                }else{
                    document.getElementById(id).src = "ModularPieces/master.png";
                }
            },
            'winloss': (id, cellValue) => {
                if(cellValue == "W"){
                    document.getElementById(id).src = "ModularPieces/w.png";
                }else{
                    document.getElementById(id).src = "ModularPieces/l.png";
                }
            }
        }
